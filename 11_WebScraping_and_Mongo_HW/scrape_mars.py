...
# Twitter API Keys
api_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath('api_keys.json')))))
...
def scrape():
    ...
    # Visit the USGS Astrogeology site and scrape pictures of the hemispheres
